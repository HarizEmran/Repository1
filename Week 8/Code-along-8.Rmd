...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      p("As the findings above demonstrate, fuel economy often referred to as miles per gallon (mpg) are determined by various factors such as the type of transmission and the gear being used. This",
