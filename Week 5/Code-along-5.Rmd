...
```{r, eval=TRUE,echo=TRUE}
# With vector input
calc_sample_mean(c(100,300,1000))
```
<br>
...
```{r, eval=TRUE,echo=TRUE}
# Enter code here
calc_sample_mean <- function(sample_size,our_mean,our_sd){sample <- rnorm(sample_size,mean=our_mean,mean(sample),sd=our_sd)}
```
<br>
